...
async function achadosDeDecisoesPendentes(empresaId) {
  ...
  return rows.map((d) => {
    ...
    return {
      ...
      descricao: d.motivo,
      dados: {
        // `tipoAcao` (20/09/2026) — mesmo motivo de especialistaAds.js:
        // dado direto pro Agente Coordenador (lib/ia/coordenadorDiario.js,
        // regra R3) reconhecer "sair_promocao" sem depender de um proxy
        // indireto tipo/prioridade.
