...
async function buscarAnunciosDaConta(contaId, { offset = 0, limit = PAGE_SIZE } = {}) {
  ...
  const atributos = 'id,title,price,available_quantity,status,listing_type_id,attributes,variations,seller_custom_field';
...
module.exports = { buscarAnunciosDaConta };
