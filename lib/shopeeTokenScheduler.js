...
// lib/shopeeCredenciais.js (mesmo bug do "Wrong sign." de 14/09/2026: este
// arquivo lia process.env.SHOPEE_PARTNER_KEY sem trim, então quando o token
// precisasse renovar de verdade a renovação ia falhar silenciosamente).
