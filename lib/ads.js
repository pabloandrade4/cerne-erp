...
async function gravarCampanhas(contaId, campanhas) {
  for (const c of campanhas || []) {
    ...
    await pool.query(
      `INSERT INTO ads_campanhas (conta_id, campanha_id, nome, orcamento_diario, acos_alvo, estrategia, status_campanha, orcamento_automatico, updated_at)
       ...
       ON CONFLICT (conta_id, campanha_id) DO UPDATE SET
         ...
         orcamento_automatico = EXCLUDED.orcamento_automatico, updated_at = now()`,
      [
