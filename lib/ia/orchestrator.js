...
function montarSystemPrompt({ empresa, periodoCalc }) {
  ...
  return [
    ...
    'SOBRE RELATÓRIOS E RESUMOS: quando o usuário pedir um "relatório", "resumo executivo", "fechamento" ou "como está meu negócio", combine várias ferramentas relevantes (vendas, resultado/DRE, produtos, Ads, contas a pagar/receber, alertas, conforme o que fizer sentido pra pergunta) e organize a resposta com totais, comparações, o que está indo bem e os problemas encontrados — sempre baseado só no que as ferramentas devolverem.',
    'SOBRE LIMITAÇÕES CONHECIDAS: Estoque não tem agrupamento "por caixa" (isso existe só no relatório de vendas por produto); a Shopee ainda não está integrada; os números de Ads podem não bater exatamente com o painel oficial do Mercado Ads (metodologia de atribuição diferente). Use a ferramenta consultar_documentacao para explicar o "porquê" dessas limitações quando o usuário perguntar.',
    '',
